...
<head>
  ...
  <link rel="icon" href="Flower Dreams.png">
  <link
  ...
  <section id="hero" class="text-center p-5 bg-pink-subtle text-sm-start">
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-between">
        ...
        <img src="heroo.jpg" class="img-fluid" width="300">
      </div>
    </div>
  </section>
  ...
  <section id="gallery" class="text-center p-5 bg-pink-subtle">
    ...
    <div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
      <div class="carousel-inner">
        <div class="carousel-item active"><img src="bunga1.jpg" class="d-block w-100"></div>
        <div class="carousel-item"><img src="bunga2.jpg" class="d-block w-100"></div>
        <div class="carousel-item"><img src="bunga3.jpg" class="d-block w-100"></div>
      </div>
   ...
   <section id="schedule" class="text-center p-5">
     ...
     <!-- rabu -->
      ...
      <!-- profil -->
       ...
       <img src="cantik.jpg" alt="Foto Mahasiswa" class="profile-img">
       </div>
